...
console.log(tyrannosaurusDinosaurs.weight);

// What was the diet of a velociraptor?
console.log(velociraptorDinosaurs.diet);

// How long was a stegosaurus?
console.log(stegosaurusDinosaurs.length);

// What time period did tyrannosaurus live in?
console.log(tyrannosaurusDinosaurs.period)


// Create a new roar method for the tyrannosaurus.  When called, return "RAWERSRARARWERSARARARRRR!" Log the result.
console.log(tyrannosaurusDinosaurs.roar());
...
const universities = graduates.map((school) => {
  return { 'first_name': school.first_name, 'university': school.university, 'email': school.email }
})
universities.sort((a, b) => a.first_name.localeCompare(b.first_name))
...
const uni = graduates.filter(uni => {
...
zooAnimals.forEach(function (animalNames) {
  console.log(animalNames.scientific_name + animalNames.animal_name)
})
...
zooAnimals.map((animal) => {
  console.log(animal.animal_name.toLocaleLowerCase())
})
